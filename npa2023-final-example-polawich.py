...
accessToken = "Bearer ZjY3ODFjNmYtYmE3YS00MzVhLWEzMzEtMzZmZWZjZTY0ZjBkYWQyMmJkM2MtNGJk_P0A1_a61a0b2b-feba-43a3-8a20-e8cc10a43c9a" 
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "44283718bfabb0251268fdb6a76d760b",
        }
...
# 11. Complete the code to format the response message.
        ...
        responseMessage = "In {location} (latitude: {locationLat}, longitute: {locationLng}), the current weather is {weather_desc} and the temperature is {weather_temp:.2f} degree celsius.\n".format(location=location, locationLat=locationLat, locationLng=locationLng, weather_desc=weather_desc, weather_temp=weather_temp)
